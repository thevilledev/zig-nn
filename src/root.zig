...
const translation_mod = @import("translation.zig");
...
pub const Sequence = sequence_mod;
pub const Translation = translation_mod;
...
pub const Ctc = ctc_mod;
pub const Graph = graph_mod;
