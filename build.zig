...
const experiments = [_]Experiment{
    ...
    .{ .name = "spectral_learning", .src = "experiments/spectral_learning/spectral_learning.zig", .description = "Compare raw-coordinate and Fourier-feature spectral learning" },
    ...
    .{ .name = "ctc_alignment", .src = "experiments/ctc_alignment/ctc_alignment.zig", .description = "Learn blank-aware alignment and CTC decoding" },
    .{ .name = "time_series", .src = "experiments/time_series/time_series.zig", .description = "Compare causal Conv1d forecasting with persistence" },
    .{ .name = "node_classification", .src = "experiments/node_classification/node_classification.zig", .description = "Compare feature-only and graph-convolution node classification" },
